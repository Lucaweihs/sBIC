...
3. [Latent class analysis](LCAs.pdf)
4. Gaussian latent forests
5. [Reduced rank regression](ReducedRankRegressions.pdf)
6. [Factor analysis](FactorAnalyses.pdf)
...
An important consequence of the use of `R.oo` is that objects in the `sBIC` package use call by reference semantics and are modified by  
