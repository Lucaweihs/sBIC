...
Section 6.2 of Drton and Plummer (2017) considers singular BIC for Gaussian mixture models usign the `galaxies` data set as an example. Singularities occur when two mixture components coincide (i.e. they have the same mean and variance) or on the boundary of the parameter space when the prior probability of a mixture component goes down to zero. 
